...
public class User implements UserDetails {
    ...
    public User(Long uid, String firstName, String lastName, String email, String phoneNumber, String password, Boolean isEnabled, Role role, Date createdAt, Date updatedAt, List<Long> cart) {
        this.uid = uid;
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
