...
export default function Footer() {
  return (
    ...
    <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
      ...
      <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
        <div className="space-y-3">
          <h3 className="tracki uppercase dark:text-gray-50 font-bold">Product</h3>
          <ul className="space-y-1">
            <li>
              <a rel="noopener noreferrer" href="/shop">Categories</a>
            </li>
        ...
        <div className="space-y-3">
          <h3 className="tracki uppercase dark:text-gray-50 font-bold">Help & Support</h3>
          <ul className="space-y-1">
            <li>
    ...
    <div className="py-6 text-sm text-center dark:text-white-400">© {currentYear} Essentia Co. All rights reserved.</div>
  </footer>
  );
}
